...
export function BillingBlockedModal() {
  ...
  return (
    <div style={{ position: 'fixed', inset: 0, background: C.overlay, display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999 }}>
      <div style={{ background: C.bg2, borderRadius: 16, border: `1px solid ${C.borderStrong}`, padding: 32, maxWidth: 420, width: '90vw' }}>
        ...
        <div style={{ display: 'flex', gap: 12, justifyContent: 'flex-end' }}>
          <button onClick={() => setVisible(false)} style={{ padding: '10px 20px', borderRadius: 8, background: C.bg3, border: `1px solid ${C.borderStrong}`, color: C.dim, cursor: 'pointer', fontFamily: F.body }}>Dismiss</button>
