...
export const DEMO_DRIVERS: DemoDriver[] = [
  { id: 'drv-001', name: 'Alex Rivera', email: 'alex.rivera@demo.homer.io', phone: '555-2001', licenseNumber: 'D1234567', status: 'on_route', skillTags: ['hazmat', 'large_vehicle'], createdAt: '2025-11-15T00:00:00Z' },
  { id: 'drv-002', name: 'Jordan Chen', email: 'jordan.chen@demo.homer.io', phone: '555-2002', licenseNumber: 'D2345678', status: 'on_route', skillTags: [], createdAt: '2025-11-20T00:00:00Z' },
  { id: 'drv-003', name: 'Sam Okafor', email: 'sam.okafor@demo.homer.io', phone: '555-2003', licenseNumber: 'D3456789', status: 'available', skillTags: ['refrigerated'], createdAt: '2025-12-01T00:00:00Z' },
  { id: 'drv-004', name: 'Morgan Patel', email: 'morgan.patel@demo.homer.io', phone: '555-2004', licenseNumber: 'D4567890', status: 'available', skillTags: [], createdAt: '2026-01-05T00:00:00Z' },
  { id: 'drv-005', name: 'Casey Nguyen', email: 'casey.nguyen@demo.homer.io', phone: '555-2005', licenseNumber: null, status: 'offline', skillTags: ['cargo_bike'], createdAt: '2026-01-15T00:00:00Z' },
];
